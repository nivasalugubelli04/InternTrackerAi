...
type Props = NativeStackScreenProps<OnboardingStackParamList, 'Step4Skills'>;
...
export default function Step4SkillsScreen({ navigation }: Props): React.ReactElement {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StepProgressBar currentStep={4} totalSteps={8} stepLabel="Skills" />
      <ScrollView showsVerticalScrollIndicator={false}>
        <StepHeader emoji="⚡" title="Your Skills" subtitle="Add skills you're proficient in. These power your matches." />
      ...
      <View style={styles.footer}>
        <TouchableOpacity onPress={() => navigation.navigate('Step5Career')} style={styles.skipBtn}>
        ...
        <PrimaryButton
          ...
          onPress={async () => {
            setContinuing(true);
            navigation.navigate('Step5Career');
            setContinuing(false);
          }}
          loading={continuing}
